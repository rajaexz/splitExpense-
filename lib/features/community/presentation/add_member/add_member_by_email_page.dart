...
class AddMemberByEmailPage extends StatefulWidget {
  final String groupId;

  const AddMemberByEmailPage({
    super.key,
    required this.groupId,
  });

  @override
  State<AddMemberByEmailPage> createState() => _AddMemberByEmailPageState();
}

enum _AddBy { email, phone, userId }

class _AddMemberByEmailPageState extends State<AddMemberByEmailPage> {
